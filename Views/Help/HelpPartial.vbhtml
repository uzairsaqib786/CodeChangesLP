        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ol>
                    ...
                    <li>Identify what you need help with.  Example:  "I need help getting data in the Open Transactions screen for order number 1234."</li>
                    <li>Use the navigation bar on the left to navigate to the appropriate view.  (Our example would be <strong>Open Transactions</strong> within the <strong>Transactions</strong> view.)
                    </li>
                    <li>Use the collapsible panels to find your specific view or problem.  The panel headings can be clicked to expand them or collapse them.
                        <ul>
                            <li>
                    ...
                    <li>If you cannot find a solution to your issue within the documentation for the specific view be sure to see any other related help pages, like <strong>Tables</strong>.</li>
