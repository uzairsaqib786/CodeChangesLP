                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input maxlength="9" id="newQtyModal" type="text" class="form-control" value="0" oninput="setNumericInRange($(this), SqlLimits.numerics.int)" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
<script src="~/Scripts/InventoryMap/ItemQtyModal.js"></script>