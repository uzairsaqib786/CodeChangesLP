...
<div class="panel panel-info">
    <div class="panel-heading">
        <h3 class="panel-title">Import Export Help</h3>
    </div>
    <div class="panel-body">
        <div class="row">
            <div class="col-md-12">
                The <strong>Import Export</strong> application allows users to configure how PickPro and related applications import and export data.
            </div>
        </div>
