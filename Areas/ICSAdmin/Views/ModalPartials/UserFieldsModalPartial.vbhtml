...
@Code
    Dim ColumnAlias As PickPro_Web.AliasModel = TryCast(Session("ColumnAlias"), PickPro_Web.AliasModel)
    Dim userAlias As List(Of String) = ColumnAlias.UserFields
    
End Code

<!-- HTML FOR userfields MODAL -->
<!-- USE:
    <button class="btn btn-primary userfields-modal-manual">View/Set User Fields  <span class="glyphicon glyphicon-resize-full"></span></button>
-->
