...
(function (h) {
    function l(f) {
        var k = h.Toggles = function (b, a) {
            if ("boolean" === typeof a && b.data("toggles")) b.data("toggles").toggle(a);
                ...
                for (var c = "on drag click width height animate easing type checkbox".split(" "), e = {}, d = 0; d < c.length; d++) {
                    ...
                    "undefined" !== typeof g && (e[c[d]] = g)
                }
                var onText = b.data("toggle-ontext");
                var offText = b.data("toggle-offtext");
                if (typeof onText == "undefined")
                {
                    onText = "ON";
                    offText = "OFF";
                }
                ...
                this.active =
                    a.on;
                b.data("toggles", this);
                this.h = "select" === a.type;
                this.l = f(a.checkbox);
                a.clicker && (this.n = f(a.clicker));
                this.m();
                this.k()
            }
        };
        k.prototype.m = function () {
            ...
            var a = this.c.height(),
                c = this.c.width();
            a || this.c.height(a = this.b.height);
            c || this.c.width(c = this.b.width);
            this.g = a;
            this.i = c;
            this.a = {
                f: b("slide"),
            ...
            this.a.off.css({
                ...
                textIndent: g ? "" : e + 5,
                lineHeight: a + "px"
            }).html(this.b.text.off).addClass("active");
            this.a.d.css({
                height: a,
                width: a,
                marginLeft: -e
            ...
            this.h && (this.a.f.addClass("toggle-select"), this.c.css("width", 2 * d), this.a.d.hide());
            this.a.e.append(this.a.on, this.a.d, this.a.off);
            this.a.f.html(this.a.e);
            this.c.html(this.a.f)
        };
        k.prototype.k = function () {
            ...
            var a =
                this;
            if (a.b.click && (!a.b.clicker || !a.b.clicker.has(a.c).length)) a.c.on("click", b);
            if (a.b.clicker) a.b.clicker.on("click", b);
            a.b.drag && !a.h && a.j()
        };
        k.prototype.j = function () {
            function b(b) {
                ...
                a.a.d.off("mouseup");
                !c && a.b.click && "mouseleave" !== b.type ? a.toggle() : (a.active ? c < -e : c > e) ? a.toggle() : a.a.e.stop().animate({
            ...
            a.a.d.on("mousedown", function (e) {
                ...
                a.c.on("mousemove", a.a.d, function (b) {
                    c = b.pageX - f;
                    a.active ? (b = c, 0 < c && (b = 0), c < d && (b = d)) : (b = c + d, 0 > c && (b = d), c > -d && (b = 0));
                    a.a.e.css("margin-left", b)
                });
                a.a.d.on("mouseup", b);
                a.a.f.on("mouseleave", b)
            })
        };
        k.prototype.toggle = function (b) {
            this.active !== b && (b = this.active = !this.active, this.c.data("toggle-active", b), this.a.off.toggleClass("active", !b), this.a.on.toggleClass("active", b), this.l.prop("checked", b), this.c.trigger(this.b.event, b), this.h || (b = b ? 0 : -this.i + this.g, this.a.e.stop().animate({
                marginLeft: b
            },
                this.b.animate)))
        };
        k.prototype.setValue = function (b) {
            this.active !== b && (b = this.active = !this.active, this.c.data("toggle-active", b), this.a.off.toggleClass("active", !b), this.a.on.toggleClass("active", b), this.l.prop("checked", b), this.h || (b = b ? 0 : -this.i + this.g, this.a.e.stop().animate({
                marginLeft: b
            },
                this.b.animate)))
        }
