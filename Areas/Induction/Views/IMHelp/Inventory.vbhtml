        ...
        <div class="panel-group" id="InventoryAccordion">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <a data-toggle="collapse" data-parent="#InventoryAccordion" data-target="#InventoryOverview">
                ...
                <div class="panel-body collapse accordion-toggle" id="InventoryOverview">
                    <div class="row">
                        <div class="col-md-12">
                            This page is the <strong>Inventory</strong> page.
                        </div>
                    </div>
