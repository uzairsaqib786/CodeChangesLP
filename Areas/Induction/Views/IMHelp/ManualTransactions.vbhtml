...
<div class="row">
    <div class="col-md-12">
        <div class="panel-group" id="ManualTransactionsAccordion">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <a data-toggle="collapse" data-parent="#ManualTransactionsAccordion" data-target="#ManualTransactionsOverview">
                ...
                <div class="panel-body collapse accordion-toggle" id="ManualTransactionsOverview">
                    <div class="row">
                        <div class="col-md-12">
                            This page is the <strong>Manual Transactions</strong> page.
                        </div>
                    </div>
