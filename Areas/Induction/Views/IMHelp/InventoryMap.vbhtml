...
<div class="row">
    <div class="col-md-12">
        <div class="panel-group" id="InventoryMapAccordion">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <a data-toggle="collapse" data-parent="#InventoryMapAccordion" data-target="#InventoryMapOverview">
                ...
                <div class="panel-body collapse accordion-toggle" id="InventoryMapOverview">
                    <div class="row">
                        <div class="col-md-12">
                            This page is the <strong>Inventory Map</strong> page.
                        </div>
                    </div>
