        ...
        <div class="panel-group" id="ReportsAccordion">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <a data-toggle="collapse" data-parent="#ReportsAccordion" data-target="#ReportsOverview">
                ...
                <div class="panel-body collapse accordion-toggle" id="ReportsOverview">
                    <div class="row">
                        <div class="col-md-12">
                            This page is the <strong>Reports</strong> page.
                        </div>
                    </div>
