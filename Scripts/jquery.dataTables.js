...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<select class="form-control input-sm"  id="selection"><option value=""></option><option value="Transaction Type">Transaction Type</option><option value="Completed Date">Completed Date</option> <option value="Location">Location</option> <option value="Transaction Quantity">Transaction Quantity</option> <option value="Item Number">Item Number</option> <option value="Line Number">Line Number</option> <option value="Required Date">Required Date</option> <option value="Description">Description</option> <option value="Completed Quantity">Completed Quantity</option> <option value="Tote ID">Tote ID</option> <option value="Priority">Priority</option> <option value="Completed By">Completed By</option> <option value="Unit of Measure">Unit of Measure</option> <option value="Lot Number">Lot Number</option> <option value="Expiration Date">Expiration Date</option> <option value="Serial Number">Serial Number</option> <option value="Revision">Revision</option> <option value="Warehouse">Warehouse</option> <option value="Import Date">Import Date</option> <option value="Batch Id">Batch Id</option> <option value="User Field1">User Field1</option> <option value="User Field2">User Field2</option> <option value="User Field3">User Field3</option> <option value="User Field4">User Field4</option> <option value="User Field5">User Field5</option> <option value="User Field6">User Field6</option> <option value="User Field7">User Field7</option> <option value="User Field">User Field8</option> <option value="User Field9<">User Field9</option> <option value="User Field10">User Field10</option> <option value="Tote Number">Tote Number</option> <option value="Cell">Cell</option> <option value="Host Transaction ID">Host Transaction ID</option> <option value="Zone">Zone</option> <option value="Emergency">Emergency</option> <option value="ID">ID</option> </select>By<input type="search" class="' + classes.sFilterInput + '"/>';
